...
#create graph without Augurs (they are all attributed 100 for analyses purposes)
ggplot(Elevation, aes(x = Elevation_Paracou_depth1, y = final_depth)) +
  geom_point() +
...
#create graph without Augurs (they are all attributed 100 for analyses purposes)
ggplot(Elevation, aes(x = final_depth, y = Elevation_Paracou_depth1)) +
  geom_point() +
  geom_smooth(method = "lm") +
  theme_minimal() + 
  labs(x = "HSD", y = "Elevation", title = "HSD-Elevation relationship")
...
augerPlot_density <- ggplot(AGB_contour, aes(x = HSD_class, y = tree_density_ha)) +
  geom_point() +
  labs(x = "HSD Class", y = "Tree density (per ha)", title = "(b)") +
  theme_minimal()
augerPlot_density
...
augerPlot_richness <- ggplot(AGB_contour, aes(x = HSD_class, y = sp_richness_ha)) +
  geom_point() +
  labs(x = "HSD Class", y = "Species richness (per ha)", title = "(a)") +
...
augerPlot_DBH <- ggplot(Merged_contour, aes(x = HSD_class, y = DBH)) + 
  geom_boxplot() + 
  labs(x = "HSD Class", y = "DBH", title = "(c)") +
  theme_minimal()
augerPlot_DBH
...
augerPlot_DBH_inf10 <- ggplot(data = filtered_DBH, aes(HSD_class, DBH)) +
  geom_boxplot() +
  geom_point() +
  labs(x = "HSD Class", y = "DBH (max 10)", title = "(d)") +
  theme_minimal()
augerPlot_DBH_inf10
