...
```{r packages and data}
require("rstudioapi")
setwd(dirname(rstudioapi::getActiveDocumentContext()$path)) #to set working directory as current file location
...
library(DescTools)
# Calculate Goodman and Kruskal's gamma to see force of association
...
mosaicplot(Auger$Silt_class ~ Auger$mica, data = Auger,
           color = TRUE, main = "Mica Silt relation", xlab="Mica content", ylab="Silt class")
#legend("topright", legend = colnames(Auger$mica), fill = c("lightgrey","grey", "darkgrey"))
# Define shades of grey and corresponding legend labels
shades_of_grey <- c("lightgrey", "grey", "darkgrey")
legend_labels <- c("Low", "Medium", "High")

# Add legend to the plot
legend("topright", legend = legend_labels, fill = shades_of_grey, title = "Silt Class")
...
# Your data and mosaic plot
mosaicplot(Auger$Silt_class ~ Auger$mica, data = Auger,
           color = TRUE, main = "Mica Silt relation", xlab="Mica content", ylab="Silt class")

# Manually define a color palette
color_palette <- gray.colors(length(unique(Auger$Silt_class)))

# Define legend labels
legend_labels <- levels(Auger$Silt_class)

# Add legend to the plot with correct colors
legend("topright", legend = legend_labels, fill = color_palette, title = "Silt Class")

cat("Number of levels in Silt_class:", length(levels(Auger$Silt_class)), "\n")
cat("Length of color_palette:", length(color_palette), "\n")
