...
fisher_result<-fisher.test(dataPitAll$siltcontent, dataPitAll$micas) # fisher's exact test due to small sampling size
```
...
library(vcd)
install.packages("vcdExtra", lib = "path_to_your_preferred_directory")
install.packages("vcdExtra")
library(vcdExtra)
install.packages("vcdExtra", lib = "/var/folders/m1/xff7vx7x5h5bb386lhznh50c0000gn/T//RtmpvgNQj7/downloaded_packages")
