...
$RI_d = \sum_{i=1}^4 r_i n_i$, with $d$ the layer depth (cm), $i$ the indice of the diameter class (< 2 mm, 2-5 mm, 5-10 mm and ≥ 10 mm), $r_i \in [1, 2, 5, 10]$ the minimum root diameter, $n_i$ the count of root in diameter class $i$. The minimum root diameter of the first class (<2mm) is set to 1mm as we assume it is the smallest diameter detectable by bare eye.
