\documentclass[fleqn,11pt]{latex/stylish_article} % Document font size and equations flushed left
...
\JournalInfo{\ }
\Archive{05/12/2023} % Additional notes (e.g. copyright, DOI, review/research article)

\PaperTitle{Impact of Superficial Lateral Drainage on Tree Root Distribution and Forest Community Structure in Paracou, French Guiana --- A Study on Drainage Barrier Depth} % Article title

\Authors{
SANVITO Emilie\textsuperscript{1*}\\ DOBETSBERGER Greta\textsuperscript{2}\\ THION Clément\textsuperscript{3}
} % Authors
\affiliation{
\textsuperscript{1}Tropimundo\\ \hspace{1em} Avenue Franklin Roosevelt 50, 1050, Belgium.\\\textsuperscript{2}Université des Antilles\\ \hspace{1em} Campus de Fouilole - BP250, 97157, France.\\\textsuperscript{3}AgroParisTech Montpellier\\ \hspace{1em} 648 Rue Jean François Breton, 34090, France.
}
\affiliation{*\textbf{Corresponding author}: \href{mailto:emilie@sanvito.be}{\nolinkurl{emilie@sanvito.be}}, } % Corresponding author

\Keywords{root, tropical forest, community structure, drainage, pedology, drought, Paracou, French Guyana, silt, superficial horizontal drainage} % Keywords
